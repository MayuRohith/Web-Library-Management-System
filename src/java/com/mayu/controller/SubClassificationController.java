...
import com.mayu.data.SubClassificationDao;
...
public class SubClassificationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       try {
           sc.setMainId(request.getParameter("mainId"));
            sc.setSubId(request.getParameter("subId"));
            sc.setSubClassification(request.getParameter("subclass"));
            
            
            //String s=request.getParameter("bookId");
            //processRequest(request, response);
            SubClassificationDao.saveSubClass(sc);
